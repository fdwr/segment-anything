            ...
            case 'webnn':
                ...
                if (typeof ep !== 'string') {
                    ...
                    if (webnnOptions?.deviceType) {
                        const keyDataOffset = (0, string_utils_1.allocWasmString)('deviceType', allocs);
                        const valueDataOffset = (0, string_utils_1.allocWasmString)(webnnOptions.deviceType, allocs);
                    ...
                    if (webnnOptions?.powerPreference) {
                        const keyDataOffset = (0, string_utils_1.allocWasmString)('powerPreference', allocs);
                        const valueDataOffset = (0, string_utils_1.allocWasmString)(webnnOptions.powerPreference, allocs);
                        if ((0, wasm_factory_1.getInstance)()._OrtAddSessionConfigEntry(sessionOptionsHandle, keyDataOffset, valueDataOffset) !==
                            0) {
